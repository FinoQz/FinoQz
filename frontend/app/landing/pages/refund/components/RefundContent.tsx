...
export default function RefundContent() {
  return (
    <div className="bg-white p-6 md:p-8 rounded-xl shadow text-left space-y-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-[var(--theme-primary)]">Refund Policy</h1>
      ...
      <div>
        <h2 className="text-xl font-semibold text-[var(--theme-primary)] mb-2">1. Free Content</h2>
        <p className="text-gray-700">
      ...
      <div>
        <h2 className="text-xl font-semibold text-[var(--theme-primary)] mb-2">2. Paid Services</h2>
        <p className="text-gray-700">
      ...
      <div>
        <h2 className="text-xl font-semibold text-[var(--theme-primary)] mb-2">3. Non-Refundable Items</h2>
      ...
      <div>
        <h2 className="text-xl font-semibold text-[var(--theme-primary)] mb-2">4. How to Request a Refund</h2>
        <p className="text-gray-700">
