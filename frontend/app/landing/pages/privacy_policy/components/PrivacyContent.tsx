...
export default function PrivacyContent() {
  return (
    <div className="bg-white p-6 md:p-8 rounded-xl shadow text-left space-y-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-[var(--theme-primary)]">Privacy Policy</h1>
      ...
      <div>
        <h2 className="text-xl font-semibold text-[var(--theme-primary)] mb-2">1. Information We Collect</h2>
      ...
      <div>
        <h2 className="text-xl font-semibold text-[var(--theme-primary)] mb-2">2. How We Use Your Data</h2>
        <ul className="list-disc pl-6 text-gray-700 space-y-1">
      ...
      <div>
        <h2 className="text-xl font-semibold text-[var(--theme-primary)] mb-2">3. Data Protection</h2>
        <p className="text-gray-700">
      ...
      <div>
        <h2 className="text-xl font-semibold text-[var(--theme-primary)] mb-2">4. Your Rights</h2>
        <p className="text-gray-700">
      ...
      <div>
        <h2 className="text-xl font-semibold text-[var(--theme-primary)] mb-2">5. Changes to This Policy</h2>
        <p className="text-gray-700">
