    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg border-2 border-gray-200">
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center">
                <RotateCcw className="w-5 h-5 text-[var(--theme-primary)]" />
              </div>
              <div>
        ...
        <div className="p-5 space-y-3">
          ...
          {/* Warning Box */}
          <div className="bg-blue-50 border-2 border-[var(--theme-primary)] rounded-xl p-3">
            <div className="flex items-start gap-2">
              <Info className="w-4 h-4 text-[var(--theme-primary)] flex-shrink-0 mt-0.5" />
              <div>
                <p className="text-xs font-bold text-[var(--theme-primary)] mb-1.5">Important Information</p>
        ...
        <div className="p-5 border-t-2 border-gray-200 bg-gray-50 flex flex-col sm:flex-row items-center gap-3">
          ...
          <button
            onClick={onConfirm}
            className="w-full sm:w-auto flex-1 px-5 py-2.5 bg-[var(--theme-primary)] text-white rounded-xl hover:bg-[var(--theme-secondary)] transition font-semibold shadow-lg flex items-center justify-center gap-2 text-sm"
          >
