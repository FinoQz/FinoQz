...
export default function UserQuizAttempt({ quizData, onExit, onSubmit, savedProgress }: UserQuizAttemptProps) {
  ...
  // Timer
  useEffect(() => {
    if (showResult || showSubmitConfirm) return;
